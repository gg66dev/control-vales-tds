...
(function(q,r,m){
	var s={
			...
			"default":"El campo %s a&uacute;n est&aacute; con el valor por defecto, por favor cambielo.",
			valid_email:"El campo %s debe contener una direcci&oacute;n de email v&aacute;lida.",
			valid_emails:"El campo %s debe contener todas las direcciones de email v&aacute;lidas.",
