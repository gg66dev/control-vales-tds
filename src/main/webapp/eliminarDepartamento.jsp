...
<div class="row space-bot">
	<h1 class="text-center">Eliminar departamento</h1>
	<p class="text-center">Est&aacute; a punto de eliminar un departamento, 
	considere que al realizar esta operaci&oacute;n usted eliminar&aacute; 
	de la base de datos los centros de costo (y usuarios) asociados a dicho departamento.</p>
</div> 
	<div class="grid">
		<p id="error"></p>
		<div class="row space-bot">
			<div class="c4 centered first">
				<form id="form" name="form" method="post"
					action="EliminarDepartamentoServlet">
					<table>
							<tr>
