...
public class ValidacionUtil {
	 ...
	 * 
	 * @param rut
	 *            el rut (s&oacute;lo n&uacute;meros, sin d&iacute;gito
	 *            verificador)
	 * @param dv
	 *            el d&iacute;gito verificador
	 * @return {@code true} si el rut es v&aacute;lido, {@code false} caso
	 *         contrario
	 */
	...
	public static boolean validarRut(String rut) {
		...
		if (rut != null && rut.replaceAll(" ", "").length() != 0
	 ...
	 * 
	 * @param email
	 * @return {@code true} en caso de que sea v&aacute;lido, {@code false} caso
	 *         contrario
	 */
	...
	/** Metodo para validar fechas en formato dado por sMascara,
	 * EJ: validaFechaMascara("11/10/2013", "dd/MM/yyyy")
	 * @param fecha La fecha a comprobar
	 * @param mascara El formato de la fecha
	 * @return {@code true} en caso de que este bien, {@code false} caso contrario
	 */
	public static boolean validaFechaMascara(String fecha, String mascara) {
		boolean retorno = true;
		try {
			SimpleDateFormat sdf = new SimpleDateFormat(mascara);
			sdf.setLenient(false); // modo estricto
			sdf.parse(fecha);
