 ...
 *
 */
@WebServlet(name = "EliminarDepartamentoServlet", urlPatterns = { "/EliminarDepartamentoServlet" })
	...
	protected void processRequest(HttpServletRequest request,
		...
		try {
			...
			if( opcion != null && opcion.equals("si")){
				eliminado = departamentoController.eliminar(departamento);
			}
		} finally {
			out.println("<html>");
			out.println("<head>");
			out.println("<title>Eliminar departamento</title>");
			out.println("</head>");
			out.println("<body>");
			out.println("<center>");
			if ( opcion.equals("si") || opcion.equals("no") ) {
				...
				out.println("Esto puede deberse a que no se encontr&oacute; el departamento en la base de datos.");
			}
